  ...
  return (
    <Container id="projects">
      <Wrapper>
        ...
        {IntroText && (
          <Desc>
           I have worked on many different projects, including FullStack and Mobile apps, Web applications, AI and Machine Learning, Deep Learning, Video Games, Algorithms & Optimization, and Desktop software. Here are some of my projects.
          </Desc>
        )}
        {projectFilters && (
          <ToggleButtonGroup>
